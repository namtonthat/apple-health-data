...
output "github_actions_secret_access_key" {
  description = "The secret access key for the github_actions IAM user. Visible locally, empty in CI."
  value       = var.show_sensitive_outputs ? aws_iam_access_key.github_actions_key.secret : ""
  sensitive   = true
}
